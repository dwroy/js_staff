...
Round.prototype.isIntersectedWithPolygon = function( polygon ){
    ...
    for( var i = 1 ; i < length ; i++ ){
        lengthToVertices.push( center.getLineLengthSquare( vertices[i] ) );
    ...
    if( lengthToVertices[ prevIndex ] < lengthToVertices[ closestVertexIndex ] &&
        lengthToVertices[ nextIndex ] < lengthToVertices[ closestVertexIndex ] ){
