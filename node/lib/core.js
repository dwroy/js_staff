/**
 * core code
 * class list: Triger , Src , O , Scene , Camera , Frame.
 * @author Roy
 *
 */
...
Trigger.prototype =
{
    ...
    addEvent: function( name , handler , bind )
    {
    ...
    trigger: function( name )
    {
        ...
        if( event )
        {
            event[0].apply( event[1] , Array.prototype.slice.call( arguments , 1 ) );
        }
    }
};
