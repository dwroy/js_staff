            ...
            function(){
                ...
                var npc = [
                        ...
                        new Npc( new Animation( images.get( 5 ) , 700 , 500 ) ,
                                1000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 800 , 150 ) ,
                                3000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 900 , 50 ) ,
                                4000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1000 , 300 ) ,
                                1000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1100 , 100 ) ,
                                2000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1200 , 500 ) ,
                                1000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1300 , 150 ) ,
                                3000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1500 , 50 ) ,
                                4000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1500 , 300 ) ,
                                1000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1600 , 100 ) ,
                                2000 ) ,
                        new Npc( new Animation( images.get( 5 ) , 1700 , 500 ) ,
                                1000 ) , ];

                var tank = new Tank( images.get( 5 ) , 0.1 );
                var cannon = new Cannon( Bomb , images.get( 6 ) , 1.5 , 5000 ,
                        20 , 500 );
                ...
                camera.addEvent( 'touchstart' , function( e ){
                    ...
                    tank.start();
                    tank.animation.lookAt( touches[ 0 ].pageX - camera.left ,
                            touches[ 0 ].pageY - camera.top );
                    tank.cannon.fire();
                } );

                camera.addEvent( 'touchend' , function( e ){
                    tank.stop();
                } );
