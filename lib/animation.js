 ...
 * @y float
 */
SceneImage.prototype.lookAt = function( x , y ){
    if( y === undefined )
...
/**
 * this method will run on every frame since this object add to scene
...
/**
 * set the state to Animation.STATE_RUN
 */
...
/**
 * set the state to Animation.STATE_STOP
 */
