...
var Camera = function( x , y , width , height , depth , container ){
    var canvas , ctx , i , camera = this , location = new Location( x , y ) , mouse = new Mouse;

    Emitter.call( this );
    this.location = location , this.width = width;
    this.height = height , this.depth = depth;
    this.container = container || document.body , this.films = [];
    this.mouse = mouse;
    ...
    canvas.addEventListener( 'mousemove' , function( e ){
        mouse.x = e.pagex - camera.left - location.x;
        mouse.y = e.pageY - camera.top - location.y;
...
/**
 * camera follow a location
 */
Camera.prototype.follow = function( location ){
